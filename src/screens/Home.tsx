...
export const Home = () => {
    return (
        <section id="home" className="relative flex justify-center items-center w-full h-screen mt-28">
            {/* Background Image */}
            ...
            {/* Main content */}
            <div className="relative z-10 flex justify-between items-center w-[80%] h-full">
                ...
                <div className="flex flex-col items-start justify-between space-y-4 max-w-lg">
                    ...
                    <button
                        className="bg-primary-100 font-Mulish font-extrabold text-white px-6 py-3 rounded-full flex space-x-2 items-center hover:brightness-105"
                    >
                ...
                <div className="relative flex flex-col items-center space-y-4">
                    ...
                    <div className="absolute z-20 transform translate-x-[50%] translate-y-[-50%] top-1/2 right-1/2">
                        <div
